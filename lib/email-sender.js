...
<ul>
    ...
    <li>Sunrise at: <b>${moment(entry.weatherApp.weather.sys.sunrise).format('HH:mm:ss')}</b></li>
    <li>Sunset at: <b>${moment(entry.weatherApp.weather.sys.sunset).format('HH:mm:ss')}</b></li>
</ul>
`;
    return html
